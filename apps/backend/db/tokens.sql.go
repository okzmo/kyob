...
SELECT id, email, username, password, display_name, avatar, banner, about, main_color, links, facts, created_at, updated_at FROM users WHERE id = (SELECT user_id FROM tokens WHERE token = $1)
`
