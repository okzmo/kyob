...
<svg xmlns="http://www.w3.org/2000/svg" {width} {height} class={classes} viewBox="0 0 24 24">
	<path
		fill="currentColor"
		d="m17 9.5l.658-.329c1.946-.973 2.92-1.46 3.63-1.02c.712.44.712 1.528.712 3.703v.292c0 2.176 0 3.263-.711 3.703c-.712.44-1.685-.047-3.63-1.02L17 14.5z"
	/>
	<path
		fill="currentColor"
		fill-rule="evenodd"
		...
		opacity=".5"
	/>
	<path fill="currentColor" d="M14 8.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0" />
</svg>
