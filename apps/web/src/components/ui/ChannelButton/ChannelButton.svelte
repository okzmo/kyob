...
<button
	id="channelButton-{id}"
	class={[
		'group hocus:bg-accent-800 hocus:text-accent-50 hocus:inner-accent/25 absolute z-20 flex items-center gap-x-2.5 px-4 py-3 font-medium transition-[color,box-shadow] duration-100 select-none hover:cursor-pointer',
		unread
